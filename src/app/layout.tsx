            ...
            >
              <div className="flex-row flex-1 flex items-center pl-3 pt-1">
                ...
                <div className="flex flex-1 justify-center items-center">
                  <h1 className="text-[#908caa] text-sm break-words">
                    caio.dev - Visual Studio Code
                  </h1>
                </div>
              </div>
              <div className="flex flex-1 h-full">
                <div className="flex-col flex">
                  <div className="">
                    <div
                      className="border-l-2 border-white p-2 flex mt-2 cursor-pointer"
                      onClick={() => {
                        setOpen(!open);
                      }}
                    >
                ...
                <div
                  className="pl-1 pt-2 overflow-hidden"
